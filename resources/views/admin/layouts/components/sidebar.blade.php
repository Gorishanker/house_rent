                ...
                <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['customers']) ? 'menu-item active' : '' }}"
                            ...
                            <span class="menu-title">{{ trans_choice('content.sidebar.customer', 3) }}</span>
                        </a>
                    </div>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['Property']) ? 'menu-item active' : '' }}"
                            ...
                            <span class="menu-title">{{ trans_choice('content.sidebar.property', 3) }}</span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['categories']) ? 'menu-item active' : '' }}"
                            ...
                            <span class="menu-title">{{ trans_choice('content.sidebar.category', 3) }}</span>
                        </a>
                    </div>
