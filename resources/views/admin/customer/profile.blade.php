                        ...
                        <div class="card-body pt-0 pt-lg-1">
                            ...
                            <div id="kt_customer_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bolder mt-5">{{ trans_choice('content.email_title', 1) }}</div>
                                    <div class="text-gray-600">
                                        <a href="#" class="text-gray-600 text-hover-primary">{{ $customer->email }}</a>
                                    </div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bolder mt-5">{{ trans_choice('content.topbar.language', 1) }}</div>
                                    <div class="text-gray-600">
                                        {{ $lang_array[$customer->lang] }}
                                    </div>
                                    <!--begin::Details item-->
